...
settled here at v0.10.0. §9 carries the rules and the incidents behind them,
this repo's 0.9.2/0.9.3 `requires-python` mismatch included. Do not restate
them here — the standard is the single copy.
