...
# Topology enum is re-exported directly from the extension.
...
def fit_best_of_n(
    hmm: Hmm, sequences, n_restarts: int, seed: int = 42, max_iters: int = 500
) -> float: ...
def initialize_topology(hmm: Hmm, topology: _core.HmmTopology, max_skip: int = 1) -> None: ...
def enforce_topology(hmm: Hmm, topology: _core.HmmTopology, max_skip: int = 1) -> None: ...
...
def fit_best_of_n_mv(
    hmm: HmmMV, sequences, n_restarts: int, seed: int = 42, max_iters: int = 500
) -> float: ...
def initialize_topology_mv(hmm: HmmMV, topology: _core.HmmTopology, max_skip: int = 1) -> None: ...
def enforce_topology_mv(hmm: HmmMV, topology: _core.HmmTopology, max_skip: int = 1) -> None: ...
